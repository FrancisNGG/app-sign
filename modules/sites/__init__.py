...
SITE_REGISTRY = {
    'acfun': {
        ...
        'auth_cookies': ['acPasstoken', 'auth_key'],
    ...
    'pcbeta': {
        ...
        'login_url': 'https://bbs.pcbeta.com/member.php?mod=logging&action=login',
        'auth_cookies': ['*_auth'],
        'description': '远景论坛',
    },
    'right': {
        ...
        'login_url': 'https://www.right.com.cn/forum/member.php?mod=logging&action=login',
        'auth_cookies': ['*_auth'],
        'description': '恩山无线论坛',
    },
    'smzdm': {
    ...
    'youdao': {
        ...
        'login_url': 'https://account.youdao.com/signIn?service=mobilemail&back_url=http%3A%2F%2Fnote.youdao.com',
        'auth_cookies': ['YNOTE_SESS'],
        'description': '有道云笔记',
    },
}
